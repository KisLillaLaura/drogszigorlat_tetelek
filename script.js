const botanicalData = {
    ...
    "Antraglikozidok": {
        "Antraglikozidokat tartalmazó drogok": ["Sennae foliolum", "Sennae fructus", "Frangulae cortex", "Rhei radix", "Aloe-drogok", "Rhamni purshianae cortex"]
    },
    "Mérges gombák": {
    ...
    "Keserűanyagok": {
        ...
        "Lanoszterol keserűanyagok": ["Colocynthidis fructus"],
    ...
    "Adaptogének és Triterpénsavak": {
        "Triterpénsavak és alkoholok": ["Olibanum indicum", "Calendulae flos", "Taraxaci officinalis herba cum radice"],
    ...
    "Terpén eredetű pszeudoalkaloidok és Glikozidok": {
        ...
        "Egyéb kéntartalmú vegyületek": ["Allii sativi bulbus", "Allii cepae bulbus"]
    }
};
